...
export class GatewayConnectionError extends Error {
  public constructor(
    message = 'Unable to connect to the chess-llama gateway',
...
export class GatewayProblemError extends Error implements ProblemDetails {
...
export class GatewayClient implements GatewayApi {
...
async function throwProblem(
  ...
  throw new GatewayResponseError(
    `Gateway returned HTTP ${response.status} without valid problem details`,
  );
}
